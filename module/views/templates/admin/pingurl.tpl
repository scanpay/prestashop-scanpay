...
<div class="scanpay--pingurl">
    <div class="scanpay--pingurl--status {$pingclass|escape:'html':'UTF-8'}">
        <div class="scanpay--pingurl--ok">
            <h4>Ok!</h4>
            <div>
                Received last ping {$pingdt_desc|escape:'html':'UTF-8'}
            </div>
        </div>
        <div class="scanpay--pingurl--warning">
            <h4>Warning!</h4>
            <div>
                Received last ping {$pingdt_desc|escape:'html':'UTF-8'}, please check that the URL above matches the URL set in
...
<div>
    <input type="text" id="scanpay--pingurl--input" value="{$pingurl|escape:'html':'UTF-8'}" readonly>
</div>
